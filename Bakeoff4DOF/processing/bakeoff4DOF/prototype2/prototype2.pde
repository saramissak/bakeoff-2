...
void scaffoldControlLogic()
{
  ...
  fill(255, 255, 255);
  rect(width-inchToPix(.8f), height-inchToPix(.9f), inchToPix(.4f), inchToPix(.4f));
  fill(0, 0, 0);
  text("CCW", width-inchToPix(.8f), height-inchToPix(.8f));
  if (mousePressed && width-inchToPix(.99f) < mouseX && mouseX < width - inchToPix(.6f) &&
      height-inchToPix(1.1f) < mouseY && mouseY < height-inchToPix(.7f))
    logoRotation--;

  //upper right corner, rotate clockwise
  fill(255, 255, 255);
  rect(width-inchToPix(.4f), height-inchToPix(.9f), inchToPix(.4f), inchToPix(.4f));
  fill(0, 0, 0);
  text("CW", width-inchToPix(.4f), height-inchToPix(.8f));
